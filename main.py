...
def main():
    ...
    file_content = read_file("article.txt") #w przypadku zmiany nazwy pliku .txt należy dokonać edycji w tym miejscu
    ...
    prompt = "Przekształć poniższy artykuł na kod HTML do wstawienia pomiędzy tagami <body> i </body>,\n " \
        ...
        "• Po każdym akapicie, jeżeli uznasz to za stosowne, dodaj tag <img> z atrybutem src='image_placeholder.jpg'" \
